...
function Note() {
    ...
    useEffect(() => {
        if (noteURL !== undefined) {
            setFormClass('hide');
            fetch("https://share-notes-0207.herokuapp.com/", {
    ...
    function getNote(event) {
        ...
        noteURL = url;
        window.location.href = "https://share-notes-0207-react.herokuapp.com/"+url
        //process.env.PORT+"/notes/" + url;
    }

    function searchNote() {
        window.location.href = "https://share-notes-0207-react.herokuapp.com/note"
        //process.env.PORT+"/notes/" + url;
    }
